...
--
-- Host: 127.0.0.1
-- Creato il: Set 10, 2019 alle 14:49
...
INSERT INTO `prodotti` (`codice`, `note`, `prezzo`) VALUES
...
CREATE TABLE `prodotti_scontrini` (
  ...
  `prezzo_applicato` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(4, 800, '2019-09-10', 10, 0),
(5, 1200, '2019-09-01', 10, 0);
